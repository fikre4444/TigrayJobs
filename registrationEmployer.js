...
function writeUserData() {
    ...
    .then((credentials) => {        
        ...
        set(ref(database, 'employers/'+userId), {
            ...
            company: allFormValues[9],
            role : allFormValues[10],
...
function validateUserInput(){
    ...
    // var studyField = document.getElementById("studyFie");
...
function handleRegistration(event){
    ...
    if(validated){
        ...
        var ids = ["firstName", "lastName", "email", "phoneNumber", "userName", "password", "confirmPassword", "region", "cityName", "company", "role"];
